            ...
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md mt-10">
                ...
                <div>
                    <div className="flex justify-center items-center gap-4">
                        <div>
                            <div className="flex items-center gap-2 text-lg text-gray-700 dark:text-white">
                        ...
                        <div className="flex justify-end">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-green-500 hover:text-green-600 transition animate-bounce" viewBox="0 0 32 32" fill="currentColor">
