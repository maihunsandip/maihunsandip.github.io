            ...
            <div className='flex flex-col md:flex-row items-center w-full md:w-[50%] py-15 md:p-5 rounded-2xl bg-[#18181B] shadow-lg md:h-60 mt-10 md:mt-15'>
                ...
                <div className='flex flex-col items-center md:gap-2 md:items-start md:ml-6'>
                    ...
                    <div className='flex space-x-6 mt-4'>
                        <a className='border border-amber-50/20 p-1 rounded-lg bg-[#27272A]' href="https://github.com/maihunsandip" target="_blank" rel="noopener noreferrer">
                            <Github size={25} />
                        </a>
                        <a className='border border-amber-50/20 p-1 rounded-lg bg-[#27272A]' href="https://linkedin.com/in/sandip-kole" target="_blank" rel="noopener noreferrer">
                            <Linkedin size={25} />
                        </a>
                        <a className='border border-amber-50/20 p-1 rounded-lg bg-[#27272A]' href="https://twitter.com/maihunsandip" target="_blank" rel="noopener noreferrer">
                            <Twitter size={25} />
                        </a>
                    </div>
                </div>
